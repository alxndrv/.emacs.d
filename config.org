...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package marginalia
    :after vertico
    :custom
    (marginalia-margin-threshold 300) ;; Make this larger than the posframe width so column spacing is correct
    :config
    (marginalia-mode))
  ...
  (use-package vertico-posframe
    ...
    (setq vertico-posframe-parameters '((internal-border-width . 10)
                                        (left-fringe . 8)
                                        (right-fringe . 8)))
    (setq vertico-posframe-height-alist '((t . 40)))
    (setq vertico-posframe-min-width 200)
    (setq vertico-posframe-width 200)
    (setq vertico-posframe-min-height 40)
...
#+BEGIN_SRC emacs-lisp
  (use-package general
    ...
    (general-define-key
     ...
     "ss" '(consult-line :which-key "Consult")
     ...
     "bb" '(persp-switch-to-buffer* :which-key "Buffer list (perspective)")
     "bB" '(switch-to-buffer :which-key "Buffer list (all)")
